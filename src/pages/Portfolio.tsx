              ...
              {loading ? (
                ...
                filteredProjects.map((project) => {
                  ...
                  <motion.a
                    ...
                    className="group relative rounded-3xl overflow-hidden aspect-[4/3] bg-white/5 cursor-pointer border border-white/5 block"
                  >
                    <img
                      src={project.image}
                      alt={project.title}
                    ...
                    <div className="absolute bottom-0 left-0 p-8 w-full flex justify-between items-end">
                      <div>
                        ...
                        <h3 
                          className="text-3xl font-bold text-white group-hover:text-accent-blue transition-colors mb-2"
